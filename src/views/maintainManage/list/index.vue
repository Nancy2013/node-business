 ...
 * @LastEditTime: 2020-09-22 15:57:56
  ...
  methods: {
    ...
    async maintainFetchList(params) {
      ...
      const { errcode, data = {} } = await locationManageAsk.siteList({
        ...params,
        name: search,
        provincial: getLocationName(provinceList, provincename),
        urban: getLocationName(urbanList, urbanname),
        areas: getLocationName(areaList, areaname),
        order: 'id',
      });
