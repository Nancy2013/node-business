 ...
 * @LastEditTime: 2020-03-13 14:03:51
  ...
  <div>
    <div class="header-panel">
      <bl-header>
        ...
        <div slot="right">
          <a-select v-model="online" :default-value="-1" class="component-w-224" @change="doSearch">
          ...
          />
          <a-input-search
            v-model.trim="locationVal"
            placeholder="输入站点名称搜索"
            class="component-w-224"
            enter-button
            @search="
              val => {
                doSearch(val, 'location');
              }
            "
          />
        </div>
      ...
      <div slot="content">
        ...
        >
          ...
          <template slot="operation" slot-scope="text, record">
            ...
            <a v-if="record.online === '1'" class="control" @click="control(record)">控制</a>
